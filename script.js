...
/* v80 — MRHG link added to links directory, gate, cursor, language system, details */
'use strict';
...
function movePointer(x, y) {
  ...
  pointerState.frame = requestAnimationFrame(() => {
    pointerState.frame = 0;
    pointer.style.transform = `translate3d(${pointerState.x}px, ${pointerState.y}px, 0) translate(-50%, -50%)`;
  });
}
